    ...
    return (
        <section className="">
            <div className="container mx-auto text-center">
                <motion.li
                    id="fh5co-couple" className="fh5co-section-gray"
                            ...
                            <div className="bg-gray-100 py-16 px-6 text-center">
                                ...
                                >
                                    <div className="w-28 h-28 overflow-hidden border-4 border-white shadow-lg flex items-center justify-center mx-auto">
                                        <Image src={'/images/wedding_gif.gif'} alt={"gif"} width={96} height={96} className="object-cover" />
                                    </div>
                                    <h2 className={`text-pink-600 text-5xl font-bold pt-16 ${sacramento.className}`}>Xin chào!</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    {[...Array(6)].map((_, index) => (
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.6, delay: Math.floor(index / 3) * 0.3 }}
                        >
                            <Image src="/images/gallery-1.jpg" alt={`Gallery Image ${index + 1}`} width={300} height={370} style={{ minHeight: 370 }} className="rounded-lg shadow-md" />
                        </motion.div>
                    ))}
                </div>
            </div>
